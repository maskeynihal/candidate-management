    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.candidate-official-details.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="official_email">{{ trans('cruds.candidateOfficialDetail.fields.official_email') }}</label>
                            <input class="form-control" type="email" name="official_email" id="official_email" value="{{ old('official_email') }}" required>
