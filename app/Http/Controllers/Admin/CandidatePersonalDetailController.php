...
class CandidatePersonalDetailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.candidatePersonalDetails.index', compact('candidatePersonalDetails'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.candidatePersonalDetails.create', compact('candidates'));
    }
    ...
    public function store(StoreCandidatePersonalDetailRequest $request)
    {
        ...
        return redirect()->route('admin.candidate-personal-details.index');
    }
    ...
    public function edit(CandidatePersonalDetail $candidatePersonalDetail)
    {
        ...
        return view('admin.candidatePersonalDetails.edit', compact('candidatePersonalDetail', 'candidates'));
    }
    ...
    public function show(CandidatePersonalDetail $candidatePersonalDetail)
    {
        ...
        return view('admin.candidatePersonalDetails.show', compact('candidatePersonalDetail'));
    }
