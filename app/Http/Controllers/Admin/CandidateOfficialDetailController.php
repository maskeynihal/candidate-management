...
class CandidateOfficialDetailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.candidateOfficialDetails.index', compact('candidateOfficialDetails'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.candidateOfficialDetails.create');
    }
    ...
    public function store(StoreCandidateOfficialDetailRequest $request)
    {
        ...
        return redirect()->route('admin.candidate-official-details.index');
    }
    ...
    public function edit(CandidateOfficialDetail $candidateOfficialDetail)
    {
        ...
        return view('admin.candidateOfficialDetails.edit', compact('candidateOfficialDetail'));
    }
    ...
    public function show(CandidateOfficialDetail $candidateOfficialDetail)
    {
        ...
        return view('admin.candidateOfficialDetails.show', compact('candidateOfficialDetail'));
    }
